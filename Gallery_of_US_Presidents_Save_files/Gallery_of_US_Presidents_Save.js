...
{return IWCreatePhotocast("http://The_Continuous_Profile/Gallery_of_US_Presidents_Save_files/rss.xml",false);}
...
IWLayoutPhotoGrid('id1',new IWPhotoGridLayout(3,new IWSize(166,166),new IWSize(166,32),new IWSize(204,213),27,27,0,new IWSize(0,0)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,null,'Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('Gallery_of_US_Presidents_Save_files/Gallery_of_US_Presidents_SaveMoz.css')
